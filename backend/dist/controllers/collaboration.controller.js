...
import { createActivityEvent, createCommentEvent, createMentionNotifications, createNotificationEvent, extractMentionEmails, } from "../lib/collaboration.js";
...
export const createProjectComment = async (req, res) => {
    try {
        ...
        await runSafeCollaborationOperation(() => createMentionNotifications({
            projectId,
            taskId: relatedTask?._id || null,
            actorId: req.user._id,
            content,
